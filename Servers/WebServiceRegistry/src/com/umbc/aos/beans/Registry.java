...
private static final String FILENAME = "E:\\Others\\Workspaces\\workspace1\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\WebServiceRegistry\\WEB-INF\\RegistryFile.txt";
static
{
...
private static Map<String, List<WebServiceBean>> loadChangesFromFile(){
	try {
		...
		Map<String, List<WebServiceBean>> serviceMap = (Map<String, List<WebServiceBean>>)in.readObject(); 
		in.close();
		file.close();
		//log
